			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="jurusan" class="form-control" required>
						...
						<option value="WEB DEVELOPER" <?php if($data['jurusan'] == 'TEKNIK INFORMATIKA'){ echo 'selected'; } ?>>WEB DEVELOPER</option>
						<option value="UI/UX" <?php if($data['jurusan'] == 'TEKNIK SIPIL'){ echo 'selected'; } ?>>UI/UX</option>
						<option value="FULLSTACK" <?php if($data['jurusan'] == 'PERTANIAN'){ echo 'selected'; } ?>>FULLSTACK</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
